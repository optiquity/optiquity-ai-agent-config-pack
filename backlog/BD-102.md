...
Type: TODO(version)
Status: Deprecated
Deprecated: 2026-06-13 (BD-214 Track-2, US-7) — premise dead twice. (1) The pack has already self-migrated to per-entry flat-file (BD-203) and the GH-Issues tracker step (BD-204) is deferred indefinitely (BD-214), so there is NO flat→tracker dog-food left to run. (2) The final ship-decision validation on the real pack repo is folded into BD-205's flat-file readiness dog-food. The flat-file-relevant intent survives in BD-205; this entry is closed as superseded.
...
Resolved: n/a (Deprecated — premise dead twice, US-7; flat-file ship-decision folded into BD-205)
