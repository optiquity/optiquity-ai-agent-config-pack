...
3. After you provide your design and pattern rules, fold them into `CLAUDE.md`, `AGENTS.md`, and the review skills before you let either tool make broad refactors.
...
5. Decide on your Python server framework (FastAPI, gRPC-only, etc.) and add a framework-specific section to `CLAUDE.md` before significant server work begins. The templates leave this intentionally open.
