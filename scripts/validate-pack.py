...
# `_TRACKER_BACKENDS` moved to validate_checks.core (BD-256 W1 seam — read by
# Check 29 here + the Check 80 twin) — re-imported via the facade's
...
# `_CHECK_54_REQUIRED_TOKENS` moved to validate_checks.core (BD-256 W1 seam —
# read by Check 54 here) — re-imported via the facade's
# `from validate_checks.core import *` above.
...
# `_CHECK_56_CANONICAL_VERBS` moved to validate_checks.core (BD-256 W1 seam —
# read by Check 56 here) — re-imported via the facade's
# `from validate_checks.core import *` above.
