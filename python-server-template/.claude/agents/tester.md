---
name: tester
description: Use for test design, verification planning, debugging failing tests, and deciding between unit, integration, and end-to-end coverage Default for: Testing (Codex).
