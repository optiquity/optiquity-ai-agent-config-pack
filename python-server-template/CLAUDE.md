...
| `format.sh` | `scripts/` | Before committing — runs ruff format and ruff check | Human or `repo-ops` agent |
| `test.sh` | `scripts/` | After implementing — runs pytest | Human or `repo-ops` agent |
