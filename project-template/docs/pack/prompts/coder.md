...
**Context:** Phase [N] of `IMPLEMENTATION_PLAN.md` is the next implementation
phase, and the listed tasks below are not yet implemented.

**Required reading:** `ARCHITECTURE.md` in full. `CHANGELOG.md`.
`IMPLEMENTATION_PLAN.md` Phase [N] in full. Plus the specific files listed in
...
- **Scope constraint:** Your primary task list is above. Do not modify files
  ...
  `IMPLEMENTATION_PLAN.md`, or `BACKLOG.md`. If during implementation you
