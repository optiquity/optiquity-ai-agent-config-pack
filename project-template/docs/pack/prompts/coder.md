...
**Context:** Phase [N] (`docs/project/implementation-plan/phase-N.md`) is the
next implementation phase, and the listed tasks below are not yet implemented.

**Required reading:** `ARCHITECTURE.md` in full. The latest `docs/project/changelog/`
entry. The Phase [N] entry `docs/project/implementation-plan/phase-N.md` in full.
Plus the specific files listed in **Files in scope** below.
...
- **Scope constraint:** Your primary task list is above. Do not modify files
  unrelated to this phase. Do not modify `ARCHITECTURE.md` or the per-entry
  `docs/project/implementation-plan/` and `docs/project/backlog/` trees. If during implementation you
...
- **Deferral comments:** If during implementation you encounter work that
  ...
  Do not write to the `docs/project/backlog/` tree — the PM chat handles that after user review.
...
in this report, formatted exactly as a `docs/project/changelog/` entry: dated header,
summary paragraph, files created/modified list, and test count. Do not write to
the `docs/project/changelog/` tree or any `.md` file in the project root — the PM chat
applies the entry after reviewer approval.
...
`docs/project/implementation-plan/phase-N.md`. Plus the specific files listed
under **Files in scope** below.
...
applying it to the `docs/project/changelog/` tree.
