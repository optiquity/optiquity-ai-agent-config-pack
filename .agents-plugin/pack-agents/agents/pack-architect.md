...
When the calling prompt specifies a design-report path, your final
action MUST land the design report at that exact path — with the Write
...
the design report as a chat message in lieu of the file is a defect.
