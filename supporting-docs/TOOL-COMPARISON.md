...
*Location: `supporting-docs/TOOL-COMPARISON.md`*
...
by this document:
- `supporting-docs/GEMINI-CLI-ANALYSIS.md` — content absorbed here
- `supporting-docs/ANDROID-ANALYSIS.md` — content absorbed here
