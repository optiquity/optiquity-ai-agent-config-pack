...
*Last updated: 2026-03. Targets Swift 6, Xcode 26.x, Python 3.12+, grpc-swift 2.x, grpcio 1.6x+, protoc / buf CLI, App Store distribution. gRPC + Proto3 applies to all first-party client/server communication; third-party integrations use their native protocols.*
