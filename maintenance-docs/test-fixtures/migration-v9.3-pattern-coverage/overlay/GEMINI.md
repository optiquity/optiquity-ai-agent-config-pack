...
Fill in FixtureProject, [PLATFORM_TARGETS], and [TRANSPORT] during project setup.
...
**FixtureProject** targets [PLATFORM_TARGETS].
...
**Active skills:** swift-best-practices, apple-architecture-core, macos-architecture <!-- FIXTURE-MARKER-GEMINI -->
