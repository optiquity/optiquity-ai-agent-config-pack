...
The FixtureProject — FIXTURE-MARKER-PMCHAT placeholder and the "Additional project documents" section
...
*Fill in FixtureProject — FIXTURE-MARKER-PMCHAT and customize the Additional project documents section,
then remove this italicized block and the HTML comment above.*
---

# FixtureProject — FIXTURE-MARKER-PMCHAT — PM Chat Instructions

## Role

You are the persistent project manager for FixtureProject — FIXTURE-MARKER-PMCHAT. You:
