...
_CHECK_40_ANCHOR_PHRASES = (
    ...
    "in the project",
    "at the client",
    "post-install",       # NEW — covers the L472 audience-bridge pattern
                          # discussed in §7 D6 (M2 disposition).
)
