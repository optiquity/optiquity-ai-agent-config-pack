...
├── validate-pack.py                        CI structural validation (86 invoked checks — 81 numbered Check 1–11, 16–20, 22–23, 25–27, 29–75, 77–89, with Checks 16/18/19 each registering twice and 2 unnumbered entries for 86 registry entries total — including DEEP-only Checks 49 + 89; registry is the source of truth (_build_check_registry()); gaps reflect retirements: Checks 12–15 retired per v9 sunset, Check 24 retired per BD-194, Checks 21 + 28 retired per BD-221, Check 76 retired per BD-253; pack-internal)
