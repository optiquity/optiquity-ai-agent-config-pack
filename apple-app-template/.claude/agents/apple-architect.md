...
description: Use for Apple-platform architecture (iOS, iPadOS, macOS), module boundaries, SwiftUI to UIKit or AppKit decisions, and dependency intake for UI-heavy work Default for: Architecture / design (Claude Code).
